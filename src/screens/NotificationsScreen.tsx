      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 40 }}>
        <View style={{ paddingHorizontal: 24 }}>
          ...
          {!isPremium && (
            <View style={{ borderRadius: 20, overflow: 'hidden', marginBottom: 16 }}>
              <View style={{ padding: 20, backgroundColor: '#f2a41e' }}>
                <Text style={{ fontSize: 15, fontWeight: '800', color: '#FFFFFF', marginBottom: 8 }}>
                  Upgrade to Premium
                </Text>
                <Text style={{ fontSize: 13, color: '#FFFFFF', fontWeight: '600', lineHeight: 18, opacity: 0.95 }}>
          ...
          <View style={{ backgroundColor: cardBackground, borderRadius: 20, padding: 20 }}>
            ...
            <Text style={{ fontSize: 13, color: textMuted, fontWeight: '600', lineHeight: 20 }}>
